...
| How *this* corpus is read, and what the mapper checks | [docs/mapper.md](docs/mapper.md) |
| What the validator challenges, and what it cannot | [docs/validator.md](docs/validator.md) |
