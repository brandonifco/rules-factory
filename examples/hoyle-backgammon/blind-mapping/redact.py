#!/usr/bin/env python3
"""Copy docs/method.md and docs/corpus-map.md into a blind bundle with every backgammon
(hoyle-1909) example removed or replaced. Each edit must match exactly once (whitespace-
insensitive). Writes the redacted docs and a REDACTIONS.md listing every edit."""
...
EDITS = [
 ...
 (M, "adapter-illustration example",
  ...
  "A table of weapon ranges, in a hypothetical rulebook, may be printed only as an\nimage — fully determined, and invisible to a plain-text adapter."),
 ...
 # ---------------- corpus-map.md ----------------
 (C, "map-stamp example extent 271-280 (the extent of the map under review)",
 ...
 (C, "beyondAdapter locator example (men placed as in Fig. 1)",
  ...
  "the\nsentence saying the ranges are as printed in the table."),
