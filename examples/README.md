...
| 5 | [SRD 5.2.1, Combat](srd-52-combat/) — Wizards of the Coast, CC-BY-4.0, pp. 13–16 | A PDF: an adapter over extracted text, page locators; turn structure; GM judgement; pointers into the Rules Glossary | 86 (68 in scope) | 17 (25% of in scope) | **Pending blind mapping** (#106 step 3). Numbered 5 by #106, though the injection trial is already called trial 5 in 0014 and 0015. Nothing changed in the method yet. Findings recorded, not decided: a quote is verbatim of the extraction, not the page; a page extent cannot end mid-page; no field for a term defined in the same corpus outside the slice; the cross-reference phrase list detects none of the SRD's pointers; assertion attribution has no field; whether a draw happens can be ambiguous |
