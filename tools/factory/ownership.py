...
TABLE = (
    ...
    Row("tools/entry-packet.py", MANAGED, 6,
        "the bounded assignment for one entry, with exact package-map input identity (0029, 0049)"),
    ...
    Row("tools/review-packet.py", MANAGED, 4,
        "one immutable review bundle and its machine-readable identity manifest (0029, 0049)"),
    ...
    Row("tools/record-verdict.py", MANAGED, 2,
        "a review verdict recorded only from the exact packet identity reviewed (0029, 0049)"),
...
RECIPE_SHA256 = {
    ...
    ".claude/agents/rules-conformance.md": {
        ...
        4: "7a120272469e3bc26c875605dd80da6c8631d056f555ac660dbe0b77b9bed85b",
    },
    ...
    "AGENTS.md": {
        ...
        11: "b56bd62504d4ba95b769380788b25e35b21f7db31325e63fddeb3b0ac9ddde5b",
    },
    "CLAUDE.md": {
    ...
    "docs/agent-team.md": {
        ...
        5: "854fab15af050dac71346073c2d87abdd1300856ae54b3d8e26cf4b5d05ca6ec",
    },
    ...
    "tools/entry-packet.py": {
        ...
        6: "7a2183b93d6d06b434645cf70dadf506ca93ccff5c2977bae7ff00f1e602da6e",
    },
    "tools/re-produce.sh": {
    ...
    "tools/review-packet.py": {
        ...
        4: "0dfca44464d06c6decad2a2d6b33cfdf33f5125e65da6536172d22dcd7425a32",
    },
    "tools/pr-policy.py": {
    ...
    "tools/record-verdict.py": {
        ...
        2: "271b713ce36182ee6b3a4e6e06aed90b2d391e0ad65b6cd032dc27b4d62c438b",
    },
