...
# overlay as it was before the edit. `scripts/engine-gate.py provenance` compares that one hash --
# `buildInputs/corpus-map.overlay.json` -- and fails while it is stale, naming this script.
#
