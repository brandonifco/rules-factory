...
#     that hashes generated bytes older than the overlay they came from -- fails here. That one
#     comparison, buildInputs[corpus-map.overlay.json], is the whole of the stale-derived-state
#     check, and a run in which it had nothing to compare fails too;
