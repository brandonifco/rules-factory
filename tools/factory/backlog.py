...
def check_bodies(engine_dir, files, package=None):
    ...
    It reads the map package provenance.json records (`_recorded_package`), so for any engine with a
    ...
    carrying the attribution notice is then refused, and any other is not checked. Returns log lines."""
